...
class AddressController extends GetxController {
  ...
  Future<List<AddressModel>> allUserAddresses() async {
    try {
      ...
      MLoaders.errorSnackBar(title: 'Address not found', message: e.toString());
      return [];
    }
  }
  ...
  updateAddress(AddressModel oldAddress) async {
    try {
      // Start Loading
      MFullScreenLoader.openLoadingDialog('Updating your Address...', MImages.docerAnimation);
      ...
      // Show Success Message
      MLoaders.successSnackBar(title: 'Congratulations', message: 'Your address has been updated successfully.');
      ...
      // Remove Loader
      MFullScreenLoader.stopLoading();
      MLoaders.errorSnackBar(title: 'Error Updated Address', message: e.toString());
    }
  }
