import 'package:the_smart_store_user/features/personalization/models/address_model.dart';
...
class UpdateAddressScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: const MAppBar(showBackArrow: true, title: Text('Update Address')),
