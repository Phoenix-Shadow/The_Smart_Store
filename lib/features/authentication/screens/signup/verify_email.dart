          ...
          child: Column(
            children: [
              ...
              SizedBox(
                ...
                child: ElevatedButton(onPressed: () => controller.checkEmailVerificationStatus(), child: const Text(MTexts .tContinue)),
              ),
              const SizedBox(height: MSizes.spaceBtwItems),
              ...
              SizedBox(
                width: double.infinity,
                child: TextButton(onPressed: () => controller.sendEmailVerification(), child: const Text(MTexts .resendEmail)),
              ),
            ],
          ),
        ),
