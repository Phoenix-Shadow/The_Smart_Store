import 'package:the_smart_store_user/common/widgets/images/m_circular_image.dart';
import 'package:the_smart_store_user/common/widgets/products/product_cards/product_card_vertical.dart';
import 'package:the_smart_store_user/common/widgets/shimmers/category_shimmer.dart';
import 'package:the_smart_store_user/common/widgets/shimmers/search_category_shimmer.dart';
import 'package:the_smart_store_user/features/shop/controllers/brand_controller.dart';
import 'package:the_smart_store_user/features/shop/controllers/categories_controller.dart';
import 'package:the_smart_store_user/features/shop/screens/all_products/all_products.dart';
import 'package:the_smart_store_user/features/shop/screens/brand/brand.dart';
                ...
                () => searchController.isLoading.value
                    ...
                    searchController.searchResults.isNotEmpty
                        ? MGridLayout(
                            ...
                            itemBuilder: (_, index) => MProductCardVertical(product: searchController.searchResults[index]),
                          )
      ...
      children: [
        ...
        Obx(
          () {
            ...
            if (brandController.isLoading.value) return const MCategoryShimmer();
              ...
              children: brandController.allBrands
                  .map((brand) => GestureDetector(
                        ...
                        child: Padding(
                          ...
                          child: MVerticalImageAndText(
                            image: brand.image,
                            title: brand.name,
                            isNetworkImage: true,
                            textColor: MHelperFunctions.isDarkMode(context) ? MColors.white : MColors.dark,
        ...
        /// Categories
        const MSectionHeading(title: 'Categories', showActionButton: false),
        ...
        Obx(
          () {
            // Check if categories are still loading
            if (categoryController.isLoading.value) return const MSearchCategoryShimmer();
          ...
          child: Column(
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  const MSectionHeading(title: 'Filter', showActionButton: false),
